...
# Getting started
## Depenedencies
You will need `zlib` installed on your development environment. Depending on your running system you can install libz either by using `homebrew` on macOS or `APT` on debian like systems:
